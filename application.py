...
<body id="sample">
  <div class="textColumn">
    <h1>Bienvenido</h1>
    <p>Esto es una prueba en el sample de Python de AWS</p>
    <p>Este ambiente fue lanzado en Elastic Beanstalk Python Platform</p>
  </div>
  ...
  <div class="linksColumn"> 
    ...
    <li><a href="https://twitter.com/"a>TWITTER</a></li>
